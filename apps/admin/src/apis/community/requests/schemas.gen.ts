...
export const $PostSummaryResponse = {
    ...
    required: ['author', 'category', 'createdAt', 'description', 'hasAttachment', 'isPinned', 'postId', 'title', 'views']
} as const;
...
`
    ...
    required: ['author', 'category', 'content', 'createdAt', 'isPinned', 'postId', 'title', 'views']
} as const;
