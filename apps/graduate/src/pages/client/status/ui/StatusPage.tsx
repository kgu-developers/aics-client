...
import { useFetchAllSchedule } from '~/feature/schedule/api/fetchAllSchedule';
import type { Schedule } from '~/feature/schedule/model/schedule';
      ...
      <div className={styles.container}>
        {isLoading ? (
          <div className={styles.loadingContainer}>
            <Spin size='large' tip='일정을 불러오는 중...' />
          </div>
        ) : (
          <>
