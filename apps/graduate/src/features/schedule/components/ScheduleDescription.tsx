...
export default function ScheduleDescription() {
	...
	const [tempDescription, setTempDescription] = useState<string>(descriptionData[0]?.description || '');
			...
			{descriptionData[selectedIndex] && (
				<div className={style.descriptionCard}>
					<div className={style.descriptionHeader}>
						<h3 className={style.descriptionTitle}>{descriptionData[selectedIndex].title}</h3>
					</div>
					<ReactQuill
						theme="snow"
