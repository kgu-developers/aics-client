...
export default function ScheduleEditModal({ scheduleData, setScheduleData }: ScheduleEditModalProps) {
		...
		setScheduleData(
			scheduleData.map(item =>
				item.stage === selectedStage
					? { ...item, startDate: startDate.format('YYYY-MM-DD'), endDate: endDate.format('YYYY-MM-DD') }
					: item,
			),
		);
