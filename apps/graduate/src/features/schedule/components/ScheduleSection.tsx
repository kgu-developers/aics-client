...
export default function ScheduleSection() {
	...
	return (
		<div className={container}>
			...
			<Table columns={columns} dataSource={schedule} pagination={false} bordered style={{ marginBottom: '24px' }} />

			<ScheduleEditModal scheduleData={schedule} setScheduleData={setSchedule} />
